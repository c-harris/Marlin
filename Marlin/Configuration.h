...
#define DEFAULT_MAX_FEEDRATE          {190, 190, 8.5, 25}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {500,500,35,10000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
